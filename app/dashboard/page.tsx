        ...
        <div className="mx-auto max-w-7xl px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            {loggedIn ? (
              ...
              <a
                href="/api/auth/login"
                className="ml-2 flex items-center gap-2 rounded-xl bg-blue-500 px-4 py-2 font-semibold text-white hover:opacity-90 transition shadow-[0_15px_60px_rgba(59,130,246,0.35)]"
              >
                → Discord login
              </a>
            )}
...
function StatPremium({ label, value }: any) {
  return (
    <div className="rounded-2xl border border-white/10 bg-[#0f141b]/75 backdrop-blur p-5 shadow-[0_30px_120px_rgba(0,0,0,0.45)]">
